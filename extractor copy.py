...
class HBLExtractor:
    ...
    SYSTEM_PROMPT = """
SYSTEM PROMPT — JSON SCHEMA-AWARE EXTRACTION (HBL/MBL)
===================================================
You are a document data extraction specialist. Extract every piece of information
from a House Bill of Lading (HBL/MBL) document and return a single valid JSON object.
...
OUTPUT FORMAT
-------------
Return ONLY one blocks, no additional prose:
...
""".strip()
  ...
  "title": "Shipment Schema (MBL)",
  "description": "JSON Schema for FCL/LCL shipments covering Master Bill of Lading  details",
  "type": "object",
  "required": [
    "service",
    "service_type",
...
"destination_code": {
  ...
  "definitions": {
    ...
    SCHEMA_HBL = {
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Shipment Schema (HBL)",
  "description": "JSON Schema for FCL/LCL shipments covering House Bill of Lading details",
  "type": "object",
  "required": [
